...
module IEEEFMA_S1(clk, rst, A, B, C, negateAB, negateC, RndMode, R);
  wire _000_;
  wire _001_;
  wire _002_;
  wire _003_;
  ...
  wire [5:0] \ieeefpfma_8_23_freq100_uid2leadingzerocounter:458 ;
  wire [30:0] inf;
  wire [30:0] inf_d1;
  wire [5:0] l;
  wire [30:0] nan;
  ...
  assign _281_ = _278_ | A[22];
  assign _282_ = ~ aisnormal;
  assign _283_ = ~ ahasnonnullsig;
  assign _284_ = _282_ & _283_;
  assign _286_ = ~ ahasnonnullsig;
  assign _287_ = aisinfornan & _286_;
  assign _288_ = aisinfornan & ahasnonnullsig;
  assign _289_ = B[23] | B[24];
  assign _290_ = _289_ | B[25];
  assign _291_ = _290_ | B[26];
  assign _292_ = _291_ | B[27];
  assign _293_ = _292_ | B[28];
  assign _294_ = _293_ | B[29];
  assign _295_ = _294_ | B[30];
  assign _297_ = B[23] & B[24];
  assign _298_ = _297_ & B[25];
  assign _299_ = _298_ & B[26];
  assign _300_ = _299_ & B[27];
  assign _301_ = _300_ & B[28];
  assign _302_ = _301_ & B[29];
  assign _303_ = _302_ & B[30];
  assign _304_ = B[0] | B[1];
  assign _305_ = _304_ | B[2];
  assign _306_ = _305_ | B[3];
  assign _308_ = _306_ | B[4];
  assign _309_ = _308_ | B[5];
  assign _310_ = _309_ | B[6];
  assign _311_ = _310_ | B[7];
  assign _312_ = _311_ | B[8];
  assign _313_ = _312_ | B[9];
  assign _314_ = _313_ | B[10];
  assign _315_ = _314_ | B[11];
  assign _316_ = _315_ | B[12];
  assign _317_ = _316_ | B[13];
  assign _319_ = _317_ | B[14];
  assign _320_ = _319_ | B[15];
  assign _321_ = _320_ | B[16];
  assign _322_ = _321_ | B[17];
  assign _323_ = _322_ | B[18];
  assign _324_ = _323_ | B[19];
  assign _325_ = _324_ | B[20];
  assign _326_ = _325_ | B[21];
  assign _327_ = _326_ | B[22];
  assign _328_ = ~ bisnormal;
  assign _330_ = ~ bhasnonnullsig;
  assign _331_ = _328_ & _330_;
  assign _332_ = ~ bhasnonnullsig;
  assign _333_ = bisinfornan & _332_;
  assign _334_ = bisinfornan & bhasnonnullsig;
  assign _335_ = aexpfield - { 7'h3f, aisnormal };
  assign _336_ = bexpfield - { 7'h3f, bisnormal };
  assign _337_ = { aexp[7], aexp } + { bexp[7], bexp };
  assign _338_ = C[23] | C[24];
  assign _339_ = _338_ | C[25];
  assign _341_ = _339_ | C[26];
  assign _342_ = _341_ | C[27];
  assign _343_ = _342_ | C[28];
  assign _344_ = _343_ | C[29];
  assign _345_ = _344_ | C[30];
  assign _346_ = C[23] & C[24];
  assign _347_ = _346_ & C[25];
  assign _348_ = _347_ & C[26];
  assign _349_ = _348_ & C[27];
  assign _350_ = _349_ & C[28];
  assign _002_ = _350_ & C[29];
  ...
  assign _137_ = tmpexpcompres1 - { 4'h0, l };
  assign _138_ = ~ cisnormal;
  assign _139_ = expdiffsmall | _138_;
  assign _307_ = _296_ | A[29];
  assign _140_ = _139_ & tmpexpcompres2[9];
  assign _141_ = l == 6'h34;
  assign _142_ = _141_ ? expdiffsmall : 1'h0;
  assign _143_ = asgn ^ bsgn;
  assign _144_ = _143_ ^ negateAB;
  assign _146_ = csgn ^ negateC;
  assign _147_ = _144_ & _146_;
  assign _148_ = aiszero | biszero;
  assign _149_ = _148_ & ciszero;
  assign _150_ = _149_ ? _147_ : _151_;
  assign _151_ = riszero ? 1'h0 : rsgntentative;
  assign _152_ = aexpplusbexp + 9'h099;
  assign _318_ = _307_ | A[30];
  assign _153_ = { 1'h0, l } + 7'h19;
  assign _154_ = ~ rissubnormal;
  assign _155_ = expdiffsmall & _154_;
  assign _157_ = _155_ ? _153_ : _159_;
  assign _158_ = expdiffsmall & rissubnormal;
  assign _159_ = _158_ ? shiftvaluecasesubnormal[6:0] : shiftvalue;
  assign _161_ = riszero ? 10'h383 : _162_;
  assign _162_ = rissubnormal ? 10'h382 : _168_;
  assign _163_ = { aexpplusbexp[8], aexpplusbexp } - { 4'h0, l };
  assign _164_ = _163_ + 10'h003;
  assign _165_ = ~ rissubnormal;
  assign _166_ = expdiffsmall & _165_;
  assign _168_ = _166_ ? _164_ : _169_;
  assign _169_ = { cexp[7], cexp[7], cexp } + 10'h001;
  assign _329_ = A[23] & A[24];
  ...
  assign _235_ = sticky1_d1 | sticky2;
  assign _236_ = fracleadingbits == 2'h0;
  assign _237_ = _236_ ? _235_ : _241_;
  assign _238_ = fractentative[0] | sticky1_d1;
  ...
  assign _265_ = tentativerisinf_d1 | roverflowed;
  assign _266_ = ~ risnan_d1;
  assign _268_ = _266_ & finalrisinf;
  assign _269_ = _268_ ? { rsgn_d1, inf_d1 } : _270_;
  assign _270_ = risnan_d1 ? { 1'h0, nan_d1 } : { rsgn_d1, resultrounded[30:0] };
  always @(posedge clk, posedge rst)
    if (rst) _271_ <= 1'h0;
    else _271_ <= risnan;
  always @(posedge clk, posedge rst)
    if (rst) _272_ <= 1'h0;
    else _272_ <= tentativerisinf;
  always @(posedge clk, posedge rst)
    if (rst) _273_ <= 1'h0;
    else _273_ <= sticky1;
  always @(posedge clk, posedge rst)
    if (rst) _274_ <= 1'h0;
    else _274_ <= rissubnormal;
  ...
  always @(posedge clk, posedge rst)
    if (rst) _277_ <= 10'h000;
    else _277_ <= exptentative;
  always @(posedge clk, posedge rst)
    if (rst) _279_ <= 31'h00000000;
    else _279_ <= inf;
  always @(posedge clk, posedge rst)
    if (rst) _280_ <= 31'h00000000;
    else _280_ <= nan;
  ...
  lzc_52_freq100_uid6_IEEEFMA_S1 ieeefpfma_8_23_freq100_uid2leadingzerocounter (
    .clk(clk),
    .i(bigsumabslowerbits),
    .o(_135_),
    .rst(rst)
  );
  leftshifter76_by_max_75_freq100_uid8_IEEEFMA_S1 normalizationshifter (
    .clk(clk),
    .r(_160_),
    .rst(rst),
    .s(normshiftvalue),
  ...
  rightshifter24_by_max_76_freq100_uid4_IEEEFMA_S1 rightshiftercomponent (
    .clk(clk),
    .r(_093_),
    .rst(rst),
    .s(shiftvalue),
  ...
  assign aisnormal = _318_;
  assign aisinfornan = _045_;
  assign ahasnonnullsig = _281_;
  assign aiszero = _284_;
  assign aisinf = _287_;
  assign aisnan = _288_;
  assign bsgn = B[31];
  assign bexpfield = B[30:23];
  assign bsigfield = B[22:0];
  assign bisnormal = _295_;
  assign bisinfornan = _303_;
  assign bhasnonnullsig = _327_;
  assign biszero = _331_;
  assign bisinf = _333_;
  assign bisnan = _334_;
  assign aexp = _335_;
  assign bexp = _336_;
  ...
  assign aexpplusbexp = _337_;
  assign csgn = C[31];
  assign cexpfield = C[30:23];
  assign csigfield = C[22:0];
  assign cisnormal = _345_;
  ...
  assign tentativerisinf_d1 = _272_;
  assign cexp = _075_;
  ...
  assign csigshifted = \rightshiftercomponent:373 ;
  assign sticky1 = _119_;
  assign sticky1_d1 = _273_;
  ...
  assign nan_d1 = _280_;
  assign \rightshiftercomponent:373  = _093_;
  assign \ieeefpfma_8_23_freq100_uid2leadingzerocounter:458  = _135_;
  assign \normalizationshifter:497  = _160_;
  assign R = _269_;
endmodule
/* verilator lint_on CASEOVERLAP*/

/* verilator lint_off CASEOVERLAP*/
module leftshifter76_by_max_75_freq100_uid8_IEEEFMA_S1(clk, rst, x, s, r);
  wire [76:0] _0_;
  wire [78:0] _1_;
  wire [82:0] _2_;
  wire [90:0] _3_;
  ...
  always @(posedge clk, posedge rst)
    if (rst) _8_ <= 77'h00000000000000000000;
    else _8_ <= level1;
  assign ps = s;
  assign ps_d1 = _7_;
  assign level0 = x;
  assign level1 = _0_;
  assign level1_d1 = _8_;
  assign level2 = _1_;
  assign level3 = _2_;
  assign level4 = _3_;
  assign level5 = _4_;
...
/* verilator lint_off CASEOVERLAP*/
module lzc_52_freq100_uid6_IEEEFMA_S1(clk, rst, i, o);
  wire _00_;
  wire _01_;
  wire [30:0] _02_;
  wire _03_;
  ...
  assign _16_ = \:812 (2'h0, 8'h5b, { _15_, _14_, _13_, _12_ });
...
/* verilator lint_off CASEOVERLAP*/
module rightshifter24_by_max_76_freq100_uid4_IEEEFMA_S1(clk, rst, x, s, r);
  wire [24:0] _0_;
  wire [26:0] _1_;
  wire [30:0] _2_;
  wire [38:0] _3_;
