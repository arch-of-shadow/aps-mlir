...
module IEEEFMA_S3(clk, rst, A, B, C, negateAB, negateC, RndMode, R);
  wire _000_;
  wire _001_;
  wire _002_;
  wire _003_;
  ...
  wire [5:0] \ieeefpfma_8_23_freq200_uid2leadingzerocounter:548 ;
  wire [30:0] inf;
  wire [30:0] inf_d1;
  wire [30:0] inf_d2;
  wire [30:0] inf_d3;
  ...
  assign _315_ = _222_ | A[27];
  assign _326_ = _315_ | A[28];
  assign _337_ = _326_ | A[29];
  assign _348_ = _337_ | A[30];
  assign _359_ = A[23] & A[24];
  assign _370_ = _359_ & A[25];
  assign _001_ = _370_ & A[26];
  ...
  assign _314_ = _300_ & _311_;
  assign _316_ = ~ ahasnonnullsig;
  assign _317_ = aisinfornan & _316_;
  assign _318_ = aisinfornan & ahasnonnullsig;
  assign _319_ = B[23] | B[24];
  assign _320_ = _319_ | B[25];
  assign _321_ = _320_ | B[26];
  assign _322_ = _321_ | B[27];
  assign _323_ = _322_ | B[28];
  assign _324_ = _323_ | B[29];
  assign _325_ = _324_ | B[30];
  assign _327_ = B[23] & B[24];
  assign _328_ = _327_ & B[25];
  assign _329_ = _328_ & B[26];
  assign _330_ = _329_ & B[27];
  assign _331_ = _330_ & B[28];
  assign _332_ = _331_ & B[29];
  assign _333_ = _332_ & B[30];
  assign _334_ = B[0] | B[1];
  assign _335_ = _334_ | B[2];
  assign _336_ = _335_ | B[3];
  assign _338_ = _336_ | B[4];
  assign _339_ = _338_ | B[5];
  assign _340_ = _339_ | B[6];
  assign _341_ = _340_ | B[7];
  assign _342_ = _341_ | B[8];
  assign _343_ = _342_ | B[9];
  assign _344_ = _343_ | B[10];
  assign _345_ = _344_ | B[11];
  assign _346_ = _345_ | B[12];
  assign _347_ = _346_ | B[13];
  assign _349_ = _347_ | B[14];
  assign _350_ = _349_ | B[15];
  assign _351_ = _350_ | B[16];
  assign _352_ = _351_ | B[17];
  assign _353_ = _352_ | B[18];
  assign _354_ = _353_ | B[19];
  assign _355_ = _354_ | B[20];
  assign _356_ = _355_ | B[21];
  assign _357_ = _356_ | B[22];
  assign _358_ = ~ bisnormal;
  assign _360_ = ~ bhasnonnullsig;
  assign _361_ = _358_ & _360_;
  assign _362_ = ~ bhasnonnullsig;
  assign _363_ = bisinfornan & _362_;
  assign _364_ = bisinfornan & bhasnonnullsig;
  assign _365_ = aexpfield - { 7'h3f, aisnormal };
  assign _366_ = bexpfield - { 7'h3f, bisnormal };
  assign _367_ = { aexp[7], aexp } + { bexp[7], bexp };
  assign _368_ = C[23] | C[24];
  assign _369_ = _368_ | C[25];
  assign _371_ = _369_ | C[26];
  assign _372_ = _371_ | C[27];
  assign _373_ = _372_ | C[28];
  assign _374_ = _373_ | C[29];
  assign _375_ = _374_ | C[30];
  assign _376_ = C[23] & C[24];
  assign _377_ = _376_ & C[25];
  assign _378_ = _377_ & C[26];
  assign _379_ = _378_ & C[27];
  assign _380_ = _379_ & C[28];
  assign _002_ = _380_ & C[29];
  ...
  assign _265_ = tentativerisinf_d3 | roverflowed;
  assign _266_ = ~ risnan_d3;
  assign _268_ = _266_ & finalrisinf;
  assign _269_ = _268_ ? { rsgn_d2, inf_d3 } : _270_;
  assign _270_ = risnan_d3 ? { 1'h0, nan_d3 } : { rsgn_d2, resultrounded[30:0] };
  ...
  always @(posedge clk, posedge rst)
    if (rst) _282_ <= 1'h0;
    else _282_ <= risnan_d2;
  always @(posedge clk, posedge rst)
    if (rst) _283_ <= 1'h0;
    else _283_ <= tentativerisinf;
  always @(posedge clk, posedge rst)
    if (rst) _284_ <= 1'h0;
    else _284_ <= tentativerisinf_d1;
  always @(posedge clk, posedge rst)
    if (rst) _285_ <= 1'h0;
    else _285_ <= tentativerisinf_d2;
  always @(posedge clk, posedge rst)
    if (rst) _286_ <= 8'h00;
    else _286_ <= cexp;
  always @(posedge clk, posedge rst)
    if (rst) _287_ <= 1'h0;
    else _287_ <= expdiffsmall;
  always @(posedge clk, posedge rst)
    if (rst) _288_ <= 7'h00;
    else _288_ <= shiftvalue;
  always @(posedge clk, posedge rst)
    if (rst) _290_ <= 1'h0;
    else _290_ <= sticky1;
  always @(posedge clk, posedge rst)
    if (rst) _291_ <= 1'h0;
    else _291_ <= sticky1_d1;
  always @(posedge clk, posedge rst)
    if (rst) _292_ <= 1'h0;
    else _292_ <= sticky1_d2;
  always @(posedge clk, posedge rst)
    if (rst) _293_ <= 1'h0;
    else _293_ <= rsgntentative;
  always @(posedge clk, posedge rst)
    if (rst) _294_ <= 10'h000;
    else _294_ <= tmpexpcompres1;
  always @(posedge clk, posedge rst)
    if (rst) _295_ <= 1'h0;
    else _295_ <= rissubnormal;
  always @(posedge clk, posedge rst)
    if (rst) _296_ <= 1'h0;
    else _296_ <= rissubnormal_d1;
  always @(posedge clk, posedge rst)
    if (rst) _297_ <= 1'h0;
    else _297_ <= riszero;
  always @(posedge clk, posedge rst)
    if (rst) _298_ <= 1'h0;
    else _298_ <= riszero_d1;
  always @(posedge clk, posedge rst)
    if (rst) _299_ <= 1'h0;
    else _299_ <= rsgn;
  always @(posedge clk, posedge rst)
  ...
  always @(posedge clk, posedge rst)
    if (rst) _302_ <= 9'h000;
    else _302_ <= shiftvaluecasesubnormal;
  always @(posedge clk, posedge rst)
    if (rst) _303_ <= 10'h000;
    else _303_ <= exptentative;
  always @(posedge clk, posedge rst)
    if (rst) _304_ <= 10'h000;
    else _304_ <= exptentative_d1;
  always @(posedge clk, posedge rst)
    if (rst) _305_ <= 31'h00000000;
    else _305_ <= inf;
  always @(posedge clk, posedge rst)
    if (rst) _306_ <= 31'h00000000;
    else _306_ <= inf_d1;
  always @(posedge clk, posedge rst)
    if (rst) _307_ <= 31'h00000000;
    else _307_ <= inf_d2;
  always @(posedge clk, posedge rst)
    if (rst) _308_ <= 31'h00000000;
    else _308_ <= nan;
  always @(posedge clk, posedge rst)
    if (rst) _309_ <= 31'h00000000;
    else _309_ <= nan_d1;
  always @(posedge clk, posedge rst)
    if (rst) _310_ <= 31'h00000000;
    else _310_ <= nan_d2;
  always @(posedge clk, posedge rst)
    if (rst) _312_ <= 1'h0;
    else _312_ <= negateAB;
  ...
  lzc_52_freq200_uid6_IEEEFMA_S3 ieeefpfma_8_23_freq200_uid2leadingzerocounter (
    .clk(clk),
    .i(bigsumabslowerbits),
    .o(_135_),
    .rst(rst)
  );
  leftshifter76_by_max_75_freq200_uid8_IEEEFMA_S3 normalizationshifter (
    .clk(clk),
    .r(_160_),
    .rst(rst),
    .s(normshiftvalue),
  ...
  rightshifter24_by_max_76_freq200_uid4_IEEEFMA_S3 rightshiftercomponent (
    .clk(clk),
    .r(_093_),
    .rst(rst),
    .s(shiftvalue),
  ...
  assign bisnormal = _325_;
  assign bisinfornan = _333_;
  assign bhasnonnullsig = _357_;
  assign biszero = _361_;
  ...
  assign risnan_d3 = _282_;
  assign tentativerisinf = _074_;
  assign tentativerisinf_d1 = _283_;
  assign tentativerisinf_d2 = _284_;
  assign tentativerisinf_d3 = _285_;
  assign cexp = _075_;
  assign cexp_d1 = _286_;
  ...
  assign expdiffsmall_d1 = _287_;
  assign tmpexpcomp3 = _088_;
  assign expdiffnotlarge = tmpexpcomp3[9];
  assign shiftvalue = _090_;
  assign shiftvalue_d1 = _288_;
  assign csigshifted = \rightshiftercomponent:463 ;
  assign sticky1 = _119_;
  assign sticky1_d1 = _290_;
  assign sticky1_d2 = _291_;
  assign sticky1_d3 = _292_;
  ...
  assign rsgntentative_d1 = _293_;
  assign bigsumabs = _133_;
  assign bigsumabslowerbits = bigsumabs[51:0];
  assign l = \ieeefpfma_8_23_freq200_uid2leadingzerocounter:548 ;
  assign tmpexpcompres1 = _136_;
  assign tmpexpcompres1_d1 = _294_;
  assign tmpexpcompres2 = _137_;
  assign rissubnormal = _140_;
  assign rissubnormal_d1 = _295_;
  assign rissubnormal_d2 = _296_;
  assign riszero = _142_;
  assign riszero_d1 = _297_;
  assign riszero_d2 = _298_;
  assign rsgn = _150_;
  assign rsgn_d1 = _299_;
  assign rsgn_d2 = _301_;
  assign shiftvaluecasesubnormal = _152_;
  assign shiftvaluecasesubnormal_d1 = _302_;
  assign normshiftvalue = _157_;
  assign bigsumnormd = \normalizationshifter:587 ;
  assign exptentative = _161_;
  assign exptentative_d1 = _303_;
  assign exptentative_d2 = _304_;
  ...
  assign nan_d2 = _309_;
  assign nan_d3 = _310_;
  assign negateab_d1 = _312_;
  assign negatec_d1 = _313_;
  assign \rightshiftercomponent:463  = _093_;
  assign \ieeefpfma_8_23_freq200_uid2leadingzerocounter:548  = _135_;
  assign \normalizationshifter:587  = _160_;
  assign R = _269_;
endmodule
/* verilator lint_on CASEOVERLAP*/

/* verilator lint_off CASEOVERLAP*/
module leftshifter76_by_max_75_freq200_uid8_IEEEFMA_S3(clk, rst, x, s, r);
  wire [76:0] _00_;
  wire [78:0] _01_;
  wire [82:0] _02_;
  wire [90:0] _03_;
  ...
  always @(posedge clk, posedge rst)
    if (rst) _11_ <= 107'h000000000000000000000000000;
    else _11_ <= level5;
  ...
  assign _03_ = ps_d1[3] ? { level3, 8'h00 } : { 8'h00, level3 };
...
/* verilator lint_off CASEOVERLAP*/
module lzc_52_freq200_uid6_IEEEFMA_S3(clk, rst, i, o);
  wire _00_;
  wire _01_;
  wire [30:0] _02_;
  wire _03_;
  ...
  assign _02_ = digit5_d1 ? level6_d1[30:0] : level6_d1[62:32];
  ...
  assign _16_ = \:942 (2'h0, 8'h5b, { _15_, _14_, _13_, _12_ });
  always @(posedge clk, posedge rst)
...
/* verilator lint_off CASEOVERLAP*/
module rightshifter24_by_max_76_freq200_uid4_IEEEFMA_S3(clk, rst, x, s, r);
  wire [24:0] _0_;
  wire [26:0] _1_;
  wire [30:0] _2_;
  wire [38:0] _3_;
