...
module IEEEFMA_H2(clk, rst, A, B, C, negateAB, negateC, RndMode, R);
  wire _000_;
  wire _001_;
  wire _002_;
  wire _003_;
  ...
  wire [4:0] \ieeefpfma_5_10_freq200_uid2leadingzerocounter:381 ;
  wire [14:0] inf;
  wire [14:0] inf_d1;
  wire [14:0] inf_d2;
  wire [4:0] l;
  ...
  assign _196_ = _111_ | A[13];
  assign _207_ = _196_ | A[14];
  assign _218_ = A[10] & A[11];
  assign _229_ = _218_ & A[12];
  assign _240_ = _229_ & A[13];
  assign _251_ = _240_ & A[14];
  assign _262_ = A[0] | A[1];
  assign _001_ = _262_ | A[2];
  ...
  assign _194_ = B[10] & B[11];
  assign _195_ = _194_ & B[12];
  assign _197_ = _195_ & B[13];
  assign _198_ = _197_ & B[14];
  assign _199_ = B[0] | B[1];
  assign _200_ = _199_ | B[2];
  assign _201_ = _200_ | B[3];
  assign _202_ = _201_ | B[4];
  assign _203_ = _202_ | B[5];
  assign _204_ = _203_ | B[6];
  assign _205_ = _204_ | B[7];
  assign _206_ = _205_ | B[8];
  assign _208_ = _206_ | B[9];
  assign _209_ = ~ bisnormal;
  assign _210_ = ~ bhasnonnullsig;
  assign _211_ = _209_ & _210_;
  assign _212_ = ~ bhasnonnullsig;
  assign _213_ = bisinfornan & _212_;
  assign _214_ = bisinfornan & bhasnonnullsig;
  assign _215_ = aexpfield - { 4'h7, aisnormal };
  assign _216_ = bexpfield - { 4'h7, bisnormal };
  assign _217_ = { aexp[4], aexp } + { bexp[4], bexp };
  assign _219_ = C[10] | C[11];
  assign _220_ = _219_ | C[12];
  assign _221_ = _220_ | C[13];
  assign _222_ = _221_ | C[14];
  assign _223_ = C[10] & C[11];
  assign _224_ = _223_ & C[12];
  assign _225_ = _224_ & C[13];
  assign _226_ = _225_ & C[14];
  assign _227_ = C[0] | C[1];
  assign _228_ = _227_ | C[2];
  assign _230_ = _228_ | C[3];
  assign _231_ = _230_ | C[4];
  assign _232_ = _231_ | C[5];
  assign _233_ = _232_ | C[6];
  assign _234_ = _233_ | C[7];
  assign _235_ = _234_ | C[8];
  assign _236_ = _235_ | C[9];
  assign _237_ = ~ cisnormal;
  assign _238_ = ~ chasnonnullsig;
  assign _239_ = _237_ & _238_;
  assign _241_ = ~ chasnonnullsig;
  assign _242_ = cisinfornan & _241_;
  assign _243_ = cisinfornan & chasnonnullsig;
  assign _244_ = aisnan | bisnan;
  assign _245_ = _244_ | cisnan;
  assign _246_ = aisinf | bisinf;
  assign _247_ = _246_ & cisinf;
  assign _248_ = asgn ^ bsgn;
  assign _249_ = _248_ ^ csgn;
  assign _250_ = _247_ & _249_;
  assign _252_ = _245_ | _250_;
  assign _253_ = biszero | bisnan;
  assign _254_ = ~ _253_;
  assign _255_ = aisinf & _254_;
  assign _256_ = aiszero | aisnan;
  assign _257_ = ~ _256_;
  assign _258_ = bisinf & _257_;
  assign _259_ = _255_ | _258_;
  assign _260_ = ~ cisnan;
  assign _261_ = _259_ & _260_;
  assign _263_ = asgn ^ bsgn;
  assign _264_ = _263_ ^ csgn;
  assign _265_ = ~ _264_;
  assign _266_ = cisinf & _265_;
  assign _267_ = ~ cisinf;
  assign _268_ = _266_ | _267_;
  assign _269_ = _261_ & _268_;
  assign _270_ = aisnan | bisnan;
  assign _271_ = ~ _270_;
  assign _272_ = cisinf & _271_;
  ...
  assign _010_ = _272_ & _009_;
  assign _011_ = _269_ | _010_;
  ...
  assign _059_ = tmpexpcompres1_d1 - { 2'h0, l };
  assign _060_ = ~ cisnormal_d1;
  assign _061_ = expdiffsmall_d1 | _060_;
  assign _062_ = _061_ & tmpexpcompres2[6];
  assign _063_ = l == 5'h1a;
  assign _064_ = _063_ ? expdiffsmall_d1 : 1'h0;
  assign _065_ = asgn_d1 ^ bsgn_d1;
  assign _066_ = _065_ ^ negateab_d1;
  assign _068_ = csgn_d1 ^ negatec_d1;
  assign _069_ = _066_ & _068_;
  assign _070_ = aiszero_d1 | biszero_d1;
  assign _071_ = _070_ & ciszero_d1;
  ...
  assign _077_ = expdiffsmall_d1 & _076_;
  assign _079_ = _077_ ? _075_ : _081_;
  assign _080_ = expdiffsmall_d1 & rissubnormal;
  assign _081_ = _080_ ? shiftvaluecasesubnormal_d1 : shiftvalue_d1;
  assign _083_ = riszero ? 7'h73 : _084_;
  assign _084_ = rissubnormal ? 7'h72 : _090_;
  assign _085_ = { aexpplusbexp_d1[5], aexpplusbexp_d1 } - { 2'h0, l };
  assign _086_ = _085_ + 7'h03;
  assign _087_ = ~ rissubnormal;
  assign _088_ = expdiffsmall_d1 & _087_;
  assign _090_ = _088_ ? _086_ : _091_;
  assign _091_ = { cexp_d1[4], cexp_d1[4], cexp_d1 } + 7'h01;
  ...
  assign _155_ = tentativerisinf_d2 | roverflowed;
  assign _157_ = ~ risnan_d2;
  assign _158_ = _157_ & finalrisinf;
  assign _159_ = _158_ ? { rsgn_d1, inf_d2 } : _160_;
  assign _160_ = risnan_d2 ? { 1'h0, nan_d2 } : { rsgn_d1, resultrounded[14:0] };
  ...
  always @(posedge clk, posedge rst)
    if (rst) _165_ <= 6'h00;
    else _165_ <= aexpplusbexp;
  always @(posedge clk, posedge rst)
    if (rst) _166_ <= 1'h0;
    else _166_ <= csgn;
  always @(posedge clk, posedge rst)
    if (rst) _168_ <= 1'h0;
    else _168_ <= cisnormal;
  always @(posedge clk, posedge rst)
    if (rst) _169_ <= 1'h0;
    else _169_ <= ciszero;
  always @(posedge clk, posedge rst)
  ...
  always @(posedge clk, posedge rst)
    if (rst) _171_ <= 1'h0;
    else _171_ <= risnan_d1;
  always @(posedge clk, posedge rst)
    if (rst) _172_ <= 1'h0;
    else _172_ <= tentativerisinf;
  always @(posedge clk, posedge rst)
    if (rst) _173_ <= 1'h0;
    else _173_ <= tentativerisinf_d1;
  always @(posedge clk, posedge rst)
    if (rst) _174_ <= 5'h00;
    else _174_ <= cexp;
  always @(posedge clk, posedge rst)
    if (rst) _175_ <= 1'h0;
    else _175_ <= expdiffsmall;
  always @(posedge clk, posedge rst)
    if (rst) _176_ <= 6'h00;
    else _176_ <= shiftvalue;
  always @(posedge clk, posedge rst)
    if (rst) _177_ <= 1'h0;
    else _177_ <= sticky1;
  always @(posedge clk, posedge rst)
    if (rst) _179_ <= 1'h0;
    else _179_ <= sticky1_d1;
  always @(posedge clk, posedge rst)
    if (rst) _180_ <= 1'h0;
    else _180_ <= rsgntentative;
  always @(posedge clk, posedge rst)
    if (rst) _181_ <= 7'h00;
    else _181_ <= tmpexpcompres1;
  always @(posedge clk, posedge rst)
    if (rst) _182_ <= 1'h0;
    else _182_ <= rissubnormal;
  always @(posedge clk, posedge rst)
    if (rst) _183_ <= 1'h0;
    else _183_ <= riszero;
  always @(posedge clk, posedge rst)
  ...
  always @(posedge clk, posedge rst)
    if (rst) _185_ <= 6'h00;
    else _185_ <= shiftvaluecasesubnormal;
  always @(posedge clk, posedge rst)
    if (rst) _186_ <= 7'h00;
    else _186_ <= exptentative;
  always @(posedge clk, posedge rst)
    if (rst) _187_ <= 15'h0000;
    else _187_ <= inf;
  always @(posedge clk, posedge rst)
    if (rst) _188_ <= 15'h0000;
    else _188_ <= inf_d1;
  always @(posedge clk, posedge rst)
    if (rst) _190_ <= 15'h0000;
    else _190_ <= nan;
  always @(posedge clk, posedge rst)
    if (rst) _191_ <= 15'h0000;
    else _191_ <= nan_d1;
  always @(posedge clk, posedge rst)
    if (rst) _192_ <= 1'h0;
    else _192_ <= negateAB;
  ...
  lzc_26_freq200_uid6_IEEEFMA_H2 ieeefpfma_5_10_freq200_uid2leadingzerocounter (
    .clk(clk),
    .i(bigsumabslowerbits),
    .o(_057_),
    .rst(rst)
  );
  leftshifter37_by_max_36_freq200_uid8_IEEEFMA_H2 normalizationshifter (
    .clk(clk),
    .r(_082_),
    .rst(rst),
    .s(normshiftvalue),
  ...
  rightshifter11_by_max_37_freq200_uid4_IEEEFMA_H2 rightshiftercomponent (
    .clk(clk),
    .r(_030_),
    .rst(rst),
    .s(shiftvalue),
  ...
  assign aisnormal = _207_;
  assign aisinfornan = _251_;
  assign ahasnonnullsig = _078_;
  assign aiszero = _112_;
  assign aiszero_d1 = _162_;
  assign aisinf = _134_;
  assign aisnan = _145_;
  assign bsgn = B[15];
  assign bsgn_d1 = _163_;
  assign bexpfield = B[14:10];
  assign bsigfield = B[9:0];
  assign bisnormal = _189_;
  assign bisinfornan = _198_;
  assign bhasnonnullsig = _208_;
  assign biszero = _211_;
  assign biszero_d1 = _164_;
  assign bisinf = _213_;
  assign bisnan = _214_;
  assign aexp = _215_;
  assign bexp = _216_;
  ...
  assign aexpplusbexp = _217_;
  assign aexpplusbexp_d1 = _165_;
  assign csgn = C[15];
  assign csgn_d1 = _166_;
  assign cexpfield = C[14:10];
  assign csigfield = C[9:0];
  assign cisnormal = _222_;
  assign cisnormal_d1 = _168_;
  assign cisinfornan = _226_;
  assign chasnonnullsig = _236_;
  assign ciszero = _239_;
  assign ciszero_d1 = _169_;
  assign cisinf = _242_;
  assign cisnan = _243_;
  assign risnan = _252_;
  assign risnan_d1 = _170_;
  assign risnan_d2 = _171_;
  assign tentativerisinf = _011_;
  assign tentativerisinf_d1 = _172_;
  assign tentativerisinf_d2 = _173_;
  assign cexp = _013_;
  assign cexp_d1 = _174_;
  ...
  assign expdiffsmall_d1 = _175_;
  assign tmpexpcomp3 = _026_;
  assign expdiffnotlarge = tmpexpcomp3[6];
  assign shiftvalue = _027_;
  assign shiftvalue_d1 = _176_;
  assign csigshifted = \rightshiftercomponent:322 ;
  assign sticky1 = _041_;
  assign sticky1_d1 = _177_;
  assign sticky1_d2 = _179_;
  ...
  assign rsgntentative_d1 = _180_;
  assign bigsumabs = _055_;
  assign bigsumabslowerbits = bigsumabs[25:0];
  assign l = \ieeefpfma_5_10_freq200_uid2leadingzerocounter:381 ;
  assign tmpexpcompres1 = _058_;
  assign tmpexpcompres1_d1 = _181_;
  assign tmpexpcompres2 = _059_;
  assign rissubnormal = _062_;
  assign rissubnormal_d1 = _182_;
  assign riszero = _064_;
  assign riszero_d1 = _183_;
  assign rsgn = _072_;
  assign rsgn_d1 = _184_;
  assign shiftvaluecasesubnormal = _074_;
  assign shiftvaluecasesubnormal_d1 = _185_;
  assign normshiftvalue = _079_;
  assign bigsumnormd = \normalizationshifter:419 ;
  assign exptentative = _083_;
  assign exptentative_d1 = _186_;
  ...
  assign nan_d1 = _190_;
  assign nan_d2 = _191_;
  assign negateab_d1 = _192_;
  assign negatec_d1 = _193_;
  assign \rightshiftercomponent:322  = _030_;
  assign \ieeefpfma_5_10_freq200_uid2leadingzerocounter:381  = _057_;
  assign \normalizationshifter:419  = _082_;
  assign R = _159_;
endmodule
/* verilator lint_on CASEOVERLAP*/

/* verilator lint_off CASEOVERLAP*/
module leftshifter37_by_max_36_freq200_uid8_IEEEFMA_H2(clk, rst, x, s, r);
  wire [37:0] _0_;
  wire [39:0] _1_;
  wire [43:0] _2_;
  wire [51:0] _3_;
...
/* verilator lint_off CASEOVERLAP*/
module lzc_26_freq200_uid6_IEEEFMA_H2(clk, rst, i, o);
  wire _00_;
  wire _01_;
  wire [14:0] _02_;
  wire _03_;
  ...
  assign _13_ = \:692 (2'h0, 8'h5b, { _12_, _11_, _10_, _09_ });
  always @(posedge clk, posedge rst)
    if (rst) _14_ <= 1'h0;
    else _14_ <= digit4;
  always @(posedge clk, posedge rst)
...
/* verilator lint_off CASEOVERLAP*/
module rightshifter11_by_max_37_freq200_uid4_IEEEFMA_H2(clk, rst, x, s, r);
  wire [11:0] _0_;
  wire [13:0] _1_;
  wire [17:0] _2_;
  wire [25:0] _3_;
