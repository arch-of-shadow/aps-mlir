...
module FPSqrt_H3(clk, rst, X, R);
  ...
  assign _29_ = ~ t7[13];
  assign _30_ = ~ d7;
  assign _31_ = t7s_h_d1 - u7_d1;
  assign _32_ = d7_d1 ? _31_ : _34_;
  assign _34_ = t7s_h_d1 + u7_d1;
  assign _35_ = ~ t8[13];
  assign _36_ = ~ d8;
  ...
  assign _58_ = \:302 (3'h6, 12'h222, { _57_, _56_, _54_, _53_ });
  ...
  always @(posedge clk, posedge rst)
    if (rst) _74_ <= 15'h0000;
    else _74_ <= t10s_h;
  always @(posedge clk, posedge rst)
    if (rst) _75_ <= 15'h0000;
    else _75_ <= u10;
  always @(posedge clk, posedge rst)
    if (rst) _76_ <= 12'h000;
    else _76_ <= s10;
  ...
  assign t3s_h_d1 = _63_;
  assign t3s_l = t3s[6:0];
  assign t3s_l_d1 = _64_;
  ...
  assign t7s_h_d1 = _69_;
  assign t7s_l = t7s[2:0];
  assign t7s_l_d1 = _70_;
  ...
  assign u8 = { 1'h0, s7_d1, d8, _36_, 1'h1 };
  assign t10_h = _38_;
